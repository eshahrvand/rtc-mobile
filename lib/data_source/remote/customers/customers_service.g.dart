...
class _CustomersService implements CustomersService {
  _CustomersService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CustomerDtoModel> getCustomerDetail(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CustomerDtoModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'orders/customers/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CustomerDtoModel _value;
    try {
      _value = CustomerDtoModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CustomerDtoModel> getCustomerByNationalId(String nationalId) async {
    ...
    final _options = _setStreamType<CustomerDtoModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'orders/customers/by-national-id/${nationalId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
